...
def plot_graph(self, x_array=[], y_array=[],
               ...
               line_style='solid', line_width=1, line_color='#000000',
               hide_borders=True, hide_ticks=False, grid=False):
    """
    ...
    # Plot data
    ax.plot(x_array, y_array, linestyle=line_style, linewidth=line_width, color=line_color, label='Line plot')
...
def plot_graph_with_arrow(self, x_array=[], y_array=[],
                          ...
                          graph_font='DejaVu Sans', math_font="stix",
                          comments_x_axis=None, comments_x_coordinates=None,
                          comments_drawing=False, comments_drawing_x=[], comments_drawing_y=[],
                          ...
                          comments_x_color='#000000', comments_size=[], comments_color=[],
                          line_style='solid', line_width=1, line_color='#000000',
                          hide_borders=False, hide_ticks=False, grid=False):
    """
    Plot a scatter plot with axis tick labels in scientific notation using AxisArtistSubplot.
    ...
    # Set axis labels and title
    ax.axis["bottom"].label.set_text(x_axis_name)
    ax.axis["bottom"].label.set_rotation(x_axis_rotation)
    ax.axis["bottom"].label.set_color(x_axis_color)
    ax.axis["bottom"].label.set_fontsize(x_axis_size)
    ax.axis["bottom"].label.set_ha(x_axis_location)

    ax.axis["left"].label.set_text(y_axis_name)
    ax.axis["left"].label.set_rotation(y_axis_rotation)
    ax.axis["left"].label.set_color(y_axis_color)
    ax.axis["left"].label.set_fontsize(y_axis_size)
    ax.axis["left"].label.set_va(y_axis_location)
